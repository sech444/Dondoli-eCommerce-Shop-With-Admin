...
const AdminUserMenu = ({ user }: AdminUserMenuProps) => {
  ...
  return (
    <div className="dropdown dropdown-end">
      <div tabIndex={0} role="button" className="w-10 h-10 rounded-full overflow-hidden cursor-pointer border-2 border-slate-200 hover:border-blue-500 transition-colors">
        {/* Use a default image if the user doesn't have one from their Google/GitHub profile */}
        <Image
          src={user?.image || "/randomuser.jpg"} // Using the placeholder you had
