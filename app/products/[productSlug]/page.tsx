...
// import prisma from "@/utils/db"; // Assuming you use Prisma or a similar DB client

// // This is your original function
// // async function getProductBySlug(slug: string) { ... }

// // 2. Wrap the function definition in cache()
// export const getProductBySlug = cache(async (slug: string) => {
//   console.log(`Fetching product with slug: ${slug}`); // This will now only log once per request
