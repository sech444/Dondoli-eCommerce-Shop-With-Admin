...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex flex-col items-center justify-center py-16 px-4">
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
        ...
        <p className="text-lg text-gray-700 mb-4 text-center">
          <strong>Boost your immune system</strong> and support your overall health
          with <strong>DONDOOIL</strong> – the leading{" "}
          <strong>natural supplement</strong> and <strong>immune booster</strong> in
          Nigeria. Our <strong>NAFDAC-approved</strong> formula combines{" "}
          <strong>organic stem cell nutrition</strong> and{" "}
          <strong>herbal remedies</strong> for holistic wellness.
        </p>
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          <span className="text-gray-600 text-sm">
            Fast, direct order via WhatsApp
          </span>
        </div>
        <div className="mt-8 text-center text-gray-500 text-xs">
          <p>
            Keywords: DONDOOIL, natural supplement, immune booster, NAFDAC
            approved, organic, herbal remedy, stem cell nutrition, holistic
            wellness, buy supplement Nigeria, immune system support, health
            product, wellness supplement, buy DONDOOIL online, Abuja, Nigeria
          </p>
        </div>
      </div>
    </div>
